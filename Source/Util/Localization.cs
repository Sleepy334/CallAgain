...
namespace CallAgain.Util
{
    public class Localization
    {
        ...
        public static void LoadAllLanguageFiles()
        {
            ...
            {
                Locale locale = LocaleFromResource("CallAgain.Locales.en.csv");
                if (locale != null)
                {
                    localeStore.Add("en", locale);
                }
                else
                {
                    Debug.Log("CallAgain.Locales.en.csv not found.");
                }
            }
        }
