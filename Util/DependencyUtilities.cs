...
namespace SleepyCommon
{
    public static class DependencyUtilities
    {
        ...
        public static void SearchPlugins()
        {
            ...
            UnityEngine.Debug.Log(sPlugins);
        }
        ...
        public static bool IsTransferManagerRunning()
        {
            const string sSTEAM_ID = "2804719780";
            return IsPluginRunning(sSTEAM_ID, "TransferManagerCE");
        }
